/**
 * MuAPI LoRA Quick Picker — HuggingFace
...
(function(){
  ...
  function renderNsfwLoraList(){ renderLoraListInto('nsfwLoraListMuapi', (typeof NSFW_LORAS!=='undefined') ? NSFW_LORAS : [], 'nsfwLoraHintMuapi', true); }
